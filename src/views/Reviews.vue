<template>
  <div id="home">
    <div class="hero-image-review">
      <div class="hero-text" style="top:30%">
        <h1 style="font-size:80px" class="title_text">More Clay</h1>
        <h1 style="font-size:80px" class="title_text">More Fun</h1>
      </div>
      <v-btn class="hero-text" style="top:90%" large color="orange">
        Get Swingshot
        <v-icon style="padding-left: 5px;">fas fa-angle-double-right</v-icon>
      </v-btn>
    </div>
    ...
    <div
      ...
      :key="review.title + review.reviewText"
      style="display:flex; justify-content:center;flex-direction:column; margin-left: 10%; margin-right: 10%; margin-top: 30px;"
    >
      <v-divider></v-divider>
      ...
      allReviews: [
        {
          ...
          source: "Site",
          title: "Best Hand Thrower Ever Made",
          reviewText:
            "This is by far the best hand held pigeon thrower I have ever used."
        },
        {
